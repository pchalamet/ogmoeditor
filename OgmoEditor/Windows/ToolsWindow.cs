...
namespace OgmoEditor.Windows
{
    public class ToolsWindow : OgmoWindow
    {
            ...
            : base(HorizontalSnap.Right, VerticalSnap.Top)
        {
            ...
            toolsForLayerTypes.Add(typeof(TileLayerDefinition), new Tool[] { new TilePencilTool(), new TileEyedropperTool(), new TileFloodTool(), new TileRectangleTool(), new TileLineTool() });
